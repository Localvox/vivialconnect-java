...
public class Log extends VivialConnectResource
{
	 ...
	 * ITEM_TYPE.ACTION, where ITEM_TYPE is the type of item that was affected and
	 * ACTION is what happened to it. For example: message.queued.
	 */
	 ...
	 * change made by a logged-in user in the Vivia Connect console, “account” for a
	 * log created during an API request, or “admin” for an log created by the
	 * internal system.
	 */
	 ...
	 * “web” for a change made by a logged-in user in the Vivial Connect console,
	 * “api” for API requests, or “system” for logs caused by an automated or
	 * internal system.
	 */
	@JsonProperty("origin")
